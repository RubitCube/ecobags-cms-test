...
<div class="container-fluid fluid0  d-none d-md-none d-lg-block">
    <a href="https://api.whatsapp.com/send?phone=971551906177" target="_blank"><img
            src="<?echo $mainurlindex;?>img/whatsappdesktop.png" alt="Shams Naturals" class="whtsapp-icon"></a>
</div>
<!------------------- whatsapp desktop ends ------------------------->
<!------------------- whatsapp mobile starts ------------------------->
<a href="https://api.whatsapp.com/send?phone=971551906177" target="_blank"><img
        src="<?echo $mainurlindex;?>img/whatsappmobile.png" alt="Shams Naturals" class="whtsapp-icon"></a>
		  ...
		  ?>
                ...
                <div class="col-12 col-xxl-2">
                    ...
                    <div class="row pb-5 pb-lg-0">
                        <div class="d-flex">
                            <a class="facebookBtn smGlobalBtn" href="https://www.facebook.com/shams.naturals"
                                style="margin-left:0px!important;"></a>
                            <a class="instagramBtn smGlobalBtn" href="https://www.instagram.com/shams_naturals7"></a>
                            <!--<a class="twitterBtn smGlobalBtn" href="#"></a>
                            <a class="linkedinBtn smGlobalBtn" href="https://ae.linkedin.com/in/shams-naturals-943b18375"></a>-->
                            <a class="tyoutubeBtn smGlobalBtn" href="https://www.youtube.com/@SHAMSNATURALS"><i class='bx bxl-youtube'></i></a>
                        </div>
                    </div>
                </div>
            </div>
		  ...
		  ?>
            ...
            <div class="row quicklink pb-4 pb-lg-4">
                <div class="col-12">
                    <div class="d-flex">
                        <a class="facebookBtn smGlobalBtn" href="https://www.facebook.com/shams.naturals"
                            target="_Blank" style="margin-left:0px!important;"></a>
                        <a class="instagramBtn smGlobalBtn" href="https://www.instagram.com/shams_naturals7"
                            target="_Blank"></a>
                        <a class="tyoutubeBtn smGlobalBtn" href="https://www.youtube.com/@SHAMSNATURALS"></i></a>    
                        <!-- <a class="twitterBtn smGlobalBtn" href="#"></a>
