...
$mainheading="Add Sub Category Level 6: ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4." - ".$master_subcategory5;
$linkheading="Add Sub Category Level 6";
$linkheading="Add Sub Category Level 6";
$subheading="";
...
<form id="basicForm" method="post" action="savesubcategory6.php" name="form" class="form-horizontal"  enctype="multipart/form-data" autocomplete="off">
 ...
 <div class="form-layout form-layout-1">
  ...
  <!-----------------inputs start--------------------------->
   <div class="col-lg-6">
    ...
    <label class="form-control-label">Sub Category Level 6 Name &nbsp;<span class="tx-danger">*</span></label>
    <input class="form-control" type="text" name="subcategory6" placeholder="Type Sub Category 6 Name..." required>
    </div>		
   </div>	
   <div class="col-lg-6">
    <div class="form-group">
   ...
   <div class="col-lg-12">
    <div class="form-group">
    <label class="form-control-label">Sub Category Level 6 Description &nbsp;</label>
    <textarea id="summernote" placeholder="Type text here..." name="subcat6desc" class="form-control" ></textarea>	
    </div>		
   </div>
  <!-----------------inputs start--------------------------->
  </div>	
