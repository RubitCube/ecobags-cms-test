...
if($pname=="category" && $page=="viewproduct.php"){
 ...
 $mainheading="Add Product SEO Keywords : ".$master_categoryname;
 }
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="subcategory.php" || $page=="subcategory2.php" || $page=="subcategory3.php" || $page=="subcategory4.php" || $page=="subcategory5.php" || $page=="subcategory6.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){
 ...
 $youarein5=""; $youarein5link=""; $youarein6=""; $youarein6link=""; $youarein7=""; $youarein7link="";$youarein8="";$youarein8link="";$youarein9="";$youarein9link="";
 $mainheading="Add Product SEO Keywords  : ".$master_categoryname." - ".$master_subcategory;
}
}
...
if($pname=="category" && $page=="product.php" || $page=="subcategory.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
	...
	$mainheading="Add Product SEO Keywords : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2;
 }
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="subcategory.php" || $page=="subcategory3.php" ||  $page=="subcategory2.php" ||  $page=="subcategory4.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
	 ...
	 $youarein9=""; $youarein9link="";
	  $mainheading="Add Product SEO Keywords  : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4." - ".$master_subcategory5;
}
}
$youareinname="Add Product SEO Keywords : ".$pname1;
$linkheading="Add Product SEO Keywords :";
$subheading="";
...
<form id="basicForm" method="post" action="saveproductkeywords.php" name="form" class="form-horizontal"  enctype="multipart/form-data" autocomplete="off"> 
 ...
 <div class="col-12">
  <div class="card bd-0 shadow-base pd-30 ">
   <div class="d-flex align-items-center justify-content-between mg-b-30">
    <div>
     <h6 class="tx-gray-800 mg-b-5">Product SEO Keywords SEO Keywords</h6>
	 <p class="mg-b-0">Please Provide the Product SEO Keywords SEO Keywords....</p>
    </div>
   </div>
   <hr>
   <!----form layout starts--->
...
<div class="form-layout-footer">
 ...
 <!--<button class="btn btn-info" name="sbutton">Save & Add Product SEO Keywords to Same Category</button>-->
</div>
</form>
...
<script>  
 $(document).ready(function(){  
	...
	$('#add4').click(function(){  
           y++;  
           $('#dynamic_field4').append('<tr id="row4'+y+'"><td><input type="text" class="form-control" name="storagespace[]"  placeholder="Product SEO Keywords Storage Space"></td><td><a href="javascript:void(0);" id="'+y+'" name="remove4" class="remove_button pull-left btn_remove4" title="Remove " ><i class="fa fa-minus" aria-hidden="true"></i></a></td></tr>'); 
      });  
