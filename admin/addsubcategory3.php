...
if($pname=="category" && $page=="subcategory2.php"){
 ...
 $youareinname="Add Sub Category Level 3";
}
...
$mainheading="Add Sub Category Level 3 : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2;
$linkheading="Add Sub Category Level 3";
$linkheading="Add Sub Category Level 3";
$subheading="";
...
<form id="basicForm" method="post" action="savesubcategory3.php" name="form" class="form-horizontal"  enctype="multipart/form-data" autocomplete="off">
 ...
 <div class="form-layout form-layout-1">
  ...
  <!-----------------inputs start--------------------------->
   <div class="col-lg-6">
    ...
    <input class="form-control" type="text" name="subcategory3" placeholder="Type Sub Category 3 Name..." required>
    </div>		
   </div>	
   <div class="col-lg-6">
    <div class="form-group">
   ...
   <div class="col-lg-12">
    ...
    <textarea id="summernote" placeholder="Type text here..." name="subcat3desc" class="form-control" ></textarea>	
    </div>		
   </div>
  <!-----------------inputs start--------------------------->
  </div>	
