...
if($pname=="category" && $page=="viewproduct.php"){
 ...
 $mainheading="Modify Product  Storage Space : ".$master_categoryname;
 }
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
 ...
 $youarein7=""; $youarein7link="";$youarein8=""; $youarein8link="";$youarein9=""; $youarein9link="";
  $mainheading="Modify Product  Storage Space : ".$master_categoryname." - ".$master_subcategory;
}
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
	...
	$mainheading="Modify Product  Storage Space : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2;
 }
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
 ...
 $youarein7=""; $youarein7link="";$youarein8=""; $youarein8link="";$youarein9=""; $youarein9link="";
  $mainheading="Modify Product Storage Space : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3;
}
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
 ...
 $youarein8=""; $youarein8link="";$youarein9=""; $youarein9link="";
 $mainheading="Modify Product Storage Space : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4;
}
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
 ...
 $youarein9=""; $youarein9link="";
 $mainheading="Modify Product Storage Space : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4." - ".$master_subcategory5;
}
}
$youareinname="Modify Product  Storage Space: ".$pname1;
$linkheading="Modify Product  Storage Space :";
$subheading="";
...
<form id="basicForm" method="post" action="updateproductstorage.php" name="form" class="form-horizontal"  enctype="multipart/form-data" autocomplete="off"> 
	   ...
	   <!----form Inputs starts--->
	    <div class="col-lg-11">
	     <table  id="dynamic_field2" style="width:110%;" cellpadding="5"> 
	      <?	$fcount = 0; 
		  $productstorage_where="productno =$productno";
		  $productstorage_result = $obj->select_all_values('productstorage', $productstorage_where,'');
		  foreach($productstorage_result as $productstorage_row){
		   $productstorageno = $productstorage_row["productstorageno"];
		   $storagespace = $productstorage_row["storagespace"];
		   $fcount++;
	      ?>		 
	      <tr>  
	       <td><input type='text' class="form-control" name="storagespace<?echo $fcount?>" value="<?echo $storagespace?>"></td>		  
	      </tr> 
	      <? } ?>
	      <input type="hidden" name="fcount" class="form-control" value="<?echo $fcount?>"> 		  
	     </table>  		
	    </div>	
	   <!----form Inputs starts--->	  
	  </div>	
