...
if($pname=="category" && $page=="viewproduct.php"){
 ...
 $mainheading="Add Product Storage Space : ".$master_categoryname;
 }
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="subcategory.php" || $page=="subcategory2.php" || $page=="subcategory3.php" || $page=="subcategory4.php" || $page=="subcategory5.php" || $page=="subcategory6.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){
 ...
 $mainheading="Add Product Storage Space  : ".$master_categoryname." - ".$master_subcategory;
}
}
...
if($pname=="category" && $page=="product.php" || $page=="subcategory.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
	...
	$mainheading="Add Product Storage Space : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2;
 }
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="subcategory.php" || $page=="subcategory3.php" ||  $page=="subcategory2.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
 ...
 $mainheading="Add Product Storage Space   : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3;
}
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="subcategory.php" || $page=="subcategory3.php" ||  $page=="subcategory2.php" ||  $page=="subcategory4.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
	 ...
	 $youarein4="Sub Category Level 3"; $youarein4link="subcategory3.php?categoryno=".$categoryno."&subcategoryno=".$subcategoryno."&subcategory2no=".$subcategory2no."&page=".$page."&pname=".$pname."&brandsno=".$brandsno;
	  ...
	  $youarein8=""; $youarein8link="";$youarein9=""; $youarein9link="";
	  $mainheading="Add Product Storage Space  : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4;
}
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="subcategory.php" || $page=="subcategory3.php" ||  $page=="subcategory2.php" ||  $page=="subcategory4.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
	 ...
	 $youarein9=""; $youarein9link="";
	  $mainheading="Add Product Storage Space  : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4." - ".$master_subcategory5;
}
}
$youareinname="Add Product Storage Space : ".$pname1;
$linkheading="Add Product Storage Space :";
$subheading="";
$bodyheading="List of all Product Storage Space";
$mainheadingdesc="";
...
<form id="basicForm" method="post" action="saveproductstorage.php" name="form" class="form-horizontal"  enctype="multipart/form-data" autocomplete="off"> 
 ...
 <div class="col-12">
  <div class="card bd-0 shadow-base pd-30 ">
   <div class="d-flex align-items-center justify-content-between mg-b-30">
    <div>
     <h6 class="tx-gray-800 mg-b-5">Product Storage Space </h6>
	 <p class="mg-b-0">Please Provide the Product Storage Space ...</p>
    </div>
   </div>
   <hr>
   <!----form layout starts--->
	...
	<div class="row mg-b-25">  
	 <div class="col-lg-12">
	  <div class="row">
	   <!----form Inputs starts--->
	    <div class="col-lg-11">
	    <table  id="dynamic_field4" style="width:115%;" cellpadding="5">  
	      <tr>  
	       <td><input type='text' class="form-control" name="storagespace[]" placeholder="Product Storage Space"></td>		 
	       <td><a href="javascript:void(0);" id="add4" class="add_button1 pull-left" title="Add"><i class="fa fa-plus" aria-hidden="true"></i></a></td>  
	      </tr>  
	     </table>  		
	    </div>	
	   <!----form Inputs starts--->	  
...
<script>  
 ...
 /*************** featues points*******************/
	...
	$('#add4').click(function(){  
           y++;  
           $('#dynamic_field4').append('<tr id="row4'+y+'"><td><input type="text" class="form-control" name="storagespace[]"  placeholder="Product Storage Space"></td><td><a href="javascript:void(0);" id="'+y+'" name="remove4" class="remove_button pull-left btn_remove4" title="Remove " ><i class="fa fa-minus" aria-hidden="true"></i></a></td></tr>'); 
      });  
