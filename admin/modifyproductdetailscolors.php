...
if($pname=="sortbrandwise" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){
 ...
 $mainheading="Modify Assigned Product Colors : ".$master_brandsname; 
 }
 }
}
if($categoryno<>0){ 
...
if($pname=="category" && $page=="viewproduct.php"){
 ...
 $youarein8="";$youarein8link="";
 $youarein9="";$youarein9link="";
 $mainheading="Modify Assigned Product Colors : ".$master_categoryname; 
 }
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
 ...
 $youarein3="Product"; $youarein3link="product.php?productno=".$productno."&categoryno=".$categoryno."&subcategoryno=".$subcategoryno."&page=".$page."&pname=".$pname; ;
 ...
 $youarein7=""; $youarein7link="";$youarein8=""; $youarein8link="";$youarein9=""; $youarein9link="";
  $mainheading="Modify Assigned Product Colors : ".$master_categoryname." - ".$master_subcategory;
}
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
    ...
    $youarein4="Product"; $youarein4link="product.php?categoryno=".$categoryno."&subcategoryno=".$subcategoryno."&subcategory2no=".$subcategory2no."&page=".$page."&pname=".$pname;
	$youarein5="View Product Details"; $youarein5link="viewproduct.php?categoryno=".$categoryno."&subcategoryno=".$subcategoryno."&subcategory2no=".$subcategory2no."&productno=".$productno."&page=".$page."&pname=".$pname;
	$youarein6=""; $youarein6link=""; $youarein7=""; $youarein7link="";$youarein8=""; $youarein8link=""; 
	$youarein9=""; $youarein9link="";
	$mainheading="Modify Assigned Product Colors : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2;
 }
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
 ...
 $youarein7=""; $youarein7link="";$youarein8=""; $youarein8link="";$youarein9=""; $youarein9link="";
  $mainheading="Modify Assigned Product Colors : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3;
}
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
 ...
 $youarein6="Product"; $youarein6link="product.php?categoryno=".$categoryno."&subcategoryno=".$subcategoryno."&subcategory2no=".$subcategory2no."&subcategory3no=".$subcategory3no."&page=".$page."&pname=".$pname."&subcategory4no=".$subcategory4no;
 ...
 $mainheading="Modify Assigned Product Colors : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4;
}
}
...
$youareinname="Modify Assigned Product Colors : ".$pname1;
$linkheading="Modify Assigned Product Colors to Storage Space :";
$subheading="";
...
<form id="basicForm" method="post" action="updateproductdetailscolors.php" name="form" class="form-horizontal"  enctype="multipart/form-data" autocomplete="off">
...
<?
 ...
 ?>
	...
	<div class="row mg-t-20">
	 <div class="col-4">
	   <label class="col-sm-4 form-control-label control-label" style="text-align:left" ><?echo $i?> ) <?echo $storagespace?></label>	  
	 </div>
	<div class="col-lg-8">
	...
	//productdetailscolors count
		$productdetailscolors_sql = "SELECT * FROM productdetailscolors where productno=$productno and productcolorsno =$productcolorsno and productdetailsno =$productdetailsno ";
		$productdetailscolors_countresult=$obj->execute($productdetailscolors_sql);
	    $productdetailscolors_count = $productdetailscolors_countresult->rowCount();
		if($productdetailscolors_count==1)
		{
			$colorname = $row["colorname"];
			?>
			<div class="col-lg-3 py-3">	
			<label for="productcolorsno<?echo $productcolorsno?><?echo $productdetailsno?>">
			<input type="checkbox" name="productcolorsno<?echo $productcolorsno?><?echo $productdetailsno?>" id="productcolorsno<?echo $productcolorsno?><?echo $productdetailsno?>" value="<?echo $productcolorsno?>" checked>
		...
		else
		{
			...
			<div class="col-lg-3 py-3">	
			<label for="productcolorsno<?echo $productcolorsno?><?echo $productdetailsno?>">
			<input type="checkbox" name="productcolorsno<?echo $productcolorsno?><?echo $productdetailsno?>" id="productcolorsno<?echo $productcolorsno?><?echo $productdetailsno?>" value="<?echo $productcolorsno?>" >
			<span>&nbsp;&nbsp;<?echo $colorname?></span>
			</label>
			 <input type="hidden" name="productcolorsno<?echo $productcolorscount?>" class="form-control" value="<?echo $productcolorsno?>">   
			 <input type="hidden" name="productdetailsno<?echo $i?>" class="form-control" value="<?echo $productdetailsno?>">   
