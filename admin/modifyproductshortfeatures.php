...
if($pname=="sortbrandwise" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){
 ...
 $mainheading="Modify Product Short Features Points : ".$master_brandsname; 
 }
 }
} 
if($categoryno<>0){
...
$pname="category"; $pnamesub="";
 ...
 $mainheading="Modify Product Short Features Points : ".$master_categoryname;
 }
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
 ...
 $youarein5=""; $youarein5link="";$youarein5=""; $youarein5link="";$youarein6=""; $youarein6link="";
 $youarein7=""; $youarein7link="";$youarein8=""; $youarein8link="";$youarein9=""; $youarein9link="";
  $mainheading="Modify Product Short Features Points : ".$master_categoryname." - ".$master_subcategory;
}
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
 ...
 $youarein8=""; $youarein8link="";$youarein9=""; $youarein9link="";
 $mainheading="Modify Product Short Features Points : ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4;
}
}
...
if($pname=="category" && $page=="product.php" || $page=="category.php" || $page=="viewproduct.php" || $page=="setpriorityproduct.php" || $page=="setpriorityproductphotos.php" || $page=="setpriorityproductpdf.php" || $page=="setpriorityproductcolors.php" || $page=="setpriorityproductdetails.php"){	
 ...
 $youarein9=""; $youarein9link="";
 $mainheading="Modify Product Short Features Points: ".$master_categoryname." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4." - ".$master_subcategory5;
}
}

$youareinname="Modify Product Short Features Points : ".$pname1;
$linkheading="Modify Product Short Features Points :";
$linkheading="Modify Product Short Features Points";
$subheading="";
...
<form id="basicForm" method="post" action="updateproductshortfeatures.php" name="form" class="form-horizontal"  enctype="multipart/form-data" autocomplete="off"> 
	   ...
	   <!----form Inputs starts--->
	    <div class="col-lg-11">
	     <table  id="dynamic_field" style="width:100%;" cellpadding="5">		 
	      ...
	      ?>		 
	      <tr>  
	       <td><input type='text' class="form-control" name="pshortfeaturepoint<?echo $fcount?>" value="<?echo $pshortfeaturepoint?>"></td>  		   
	      </tr> 
	      <? } ?>
