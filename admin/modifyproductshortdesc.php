...
if($pname=="category" && $page=="viewproduct.php"){
 ...
 $mainheading="Modify Product Short  Description : ".$master_categoryname;
 }
}
...
if($pname=="category" && $page=="viewproduct.php"){
 ...
 $youarein5=""; $youarein5link="";$youarein6=""; $youarein6link=""; $youarein7=""; $youarein7link="";
 $youarein8="";$youarein8link="";$youarein9="";$youarein9link="";
 $mainheading="Modify Product Short  Description : ".$master_categoryname.." - ".$master_subcategory;
}
}
...
if($pname=="category" && $page=="viewproduct.php"){
 ...
 $mainheading="Modify Product Short Description : ".$master_categoryname.." - ".$master_subcategory." - ".$master_subcategory2;
}
}
...
if($pname=="category" && $page=="viewproduct.php"){
 ...
 $youarein8="";$youarein8link="";$youarein9="";$youarein9link="";
 $mainheading="Modify Product Short Description: ".$master_categoryname.." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3;
 }
}
...
if($pname=="category" && $page=="viewproduct.php"){
 ...
 $mainheading="Modify Product Short Description: ".$master_categoryname.." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4;
 }
}
...
if($pname=="category" && $page=="viewproduct.php"){
 ...
 $mainheading="Modify Product Short Description : ".$master_categoryname.." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4." - ".$master_subcategory5;
 }
}
...
if($pname=="category" && $page=="viewproduct.php"){
 ...
 $mainheading="Modify Product Short Description: ".$master_categoryname.." - ".$master_subcategory." - ".$master_subcategory2." - ".$master_subcategory3." - ".$master_subcategory4." - ".$master_subcategory5." - ".$master_subcategory6;
 }
}
if($categoryno<>0 && $subcategoryno<>0 && $subcategory2no<>0 && $subcategory3no<>0 && $subcategory4no<>0 && $subcategory5no<>0){
...
$youareinname="Modify  Product Short Description: ".$pname1;
$linkheading="Modify  Product Short Description :";
$subheading="";
...
<?
 ...
 ?>
<form id="basicForm" method="post" action="updateproductshortdesc.php" name="form" class="form-horizontal"  enctype="multipart/form-data" autocomplete="off"> 
	...
	<div class="row mg-b-25">  
	 <div class="col-lg-12">
	  <div class="row">
	   <!----form Inputs starts--->
	    <div class="col-lg-12">
	     <textarea  placeholder="Type text here..." name="shortdesc1" class="form-control" rows="10"><?echo $shortdesc1?></textarea>		
	    </div>	
	   <!----form Inputs starts--->	  
	  </div>	
	 </div>
