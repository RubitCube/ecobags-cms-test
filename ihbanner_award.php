		...
		<div class="carousel-inner">
			...
			<div class="carousel-item active">
				<div class="carousel-item">
					...
					<img src="img/hbanner02.jpg" class="d-block w-100 animated" alt="..." loading="lazy">

					<div class="carousel4head animated fadeInLeft d-flex" style="visibility: visible;animation-delay: 0.1s;animation-name: fadeInLeft;">
					...
					<div class="carousel4subhead01 animated fadeInLeft d-flex" style="visibility: visible;animation-delay: 0.1s;animation-name: fadeInLeft;">
					...
					<div class="carousel4subhead animated fadeInLeft" style="visibility: visible;animation-delay: 0.5s;animation-name: fadeInLeft;">
					...
					<div class="carousel4subhead02 animated fadeInLeft" style="visibility: visible;animation-delay: 0.5s;animation-name: fadeInLeft;">
			...
			<div class="carousel-item">
				...
				<img src="img/hbanner01.jpg" class="d-block w-100 animated" alt="..." loading="lazy">
			...
			<div class="carousel-item">
				<img src="img/hbanner04.png" class="d-block w-100 animated" alt="recognitionbanner" loading="lazy">
				...
				<div class="carousel2head animated fadeInLeft d-flex" style="visibility: visible;animation-delay: 0.1s;animation-name: fadeInLeft;">
					...
					<h1 class="mb-0">Global Recognition</h1>
				...
				<div class="carousel2subhead01 animated fadeInLeft d-flex" style="visibility: visible;animation-delay: 0.1s;animation-name: fadeInLeft;">
					...
					<h1 class="mb-0">Awarded Excellence</h1>
				...
				<div class="carousel2subhead animated fadeInLeft" style="visibility: visible;animation-delay: 0.5s;animation-name: fadeInLeft;">
					...
					<h1 class="mb-0">at Johannesburg</h1>
...
<div id="carouselExampleIndicators" class="carousel slide d-block d-lg-none" data-bs-ride="carousel" data-bs-pause="false">
	...
	<div class="carousel-inner">
		...
		<div class="carousel-item active">
			...
			<img src="img/mhbanner02.jpg" class="d-block w-100 " alt="mbanner" loading="lazy">
		...
		<div class="carousel-item">
			...
			<img src="img/mhbanner03.jpg" class="d-block w-100 " alt="mbanner" loading="lazy">

		</div>

		<div class="carousel-item">

			<img src="img/mhbanner01.jpg" class="d-block w-100" alt="mbanner" loading="lazy">

		</div>

		<div class="carousel-item">

			<img src="img/mhbanner04.png" class="d-block w-100 animated" alt="mbanner" loading="lazy">
