 ...
 <div class="container pb-3"> 
  <div class="row">
   <nav class="navbar bootsnav navbar-left pb-lg-0">
    <div class="col-lg-2 col-xl-3 col-xxl-3 my-auto pt-2 pb-lg-0 pb-2">
    ...
    <div class="col-lg-10 col-xl-9 col-xxl-9 my-auto pt-1 pt-lg-4  pb-lg-3 pb-2 ps-xxl-0">  
	 <div class="navbox-collapse collapse ps-5 ps-lg-0 ps-xl-2 d-flex  float-end" id="navbar-menu" >
	  <ul class="nav flex ps-xxl-0" data-in="fade-In-Down" data-out="fade-Out-Up">
		...
		<li>
	      <div class="row mx-0 pb-3">
		   ...
		   <?if ($subcategory_tcount==0){ ?>
		    <div class="col-menu col-sm-6 col-md-6 col-xl-6 pt-4 categoryboxbg px-0 px-xl-2 pe-2">
	   ...
	   <li class="dropdown megamenu-fw">
	    <a href="<?echo $mainurlindex;?>ContactShamsNaturals" style="padding-right:10px!important;">CONTACT</a>
       </li>
	  </ul>
	 </div>
    </div>
